...
const saladsAndTandoor = [
    ...
    { id: "st8", type: "standard", name: "Chana Chaat", price: 600, img: "images/8.8.jpg" },
    { id: "st9", type: "standard", name: "Apple Cabbage Salad", price: 550, img: "images/8.10.jpg" },
    { id: "st10", type: "standard", name: "Macaroni Salad", price: 500, img: "images/8.9.jpg" },
...
const drinksAndDesserts = [
    ...
    // Fresh Juices
    {
        ...
        name: "Fresh Juices",
        options: [
            { label: "Apple Juice", price: 450 },
            { label: "Orange Juice", price: 450 },
            { label: "Pineapple Juice", price: 450 },
            { label: "Peach Juice", price: 450 },
            { label: "Pomegranate Juice", price: 500 }
        ],
        img: "images/fresh-juice.jpg"
    },
    ...
    // Fresh Lime & Soda
    {
        ...
        options: [
            { label: "Fresh Lime 7Up", price: 200 },
            { label: "Fresh Lime Water", price: 150 }
        ],
        img: "images/fresh-lime.jpg"
    },

    // Soft Drink Cans (NEW SEPARATE DROPDOWN)
    {
        id: "d13_cans",
        type: "custom",
        name: "Soft Drink (Can)",
        options: [
            { label: "Pepsi Can", price: 120 },
            { label: "7Up Can", price: 120 },
            { label: "Mirinda Can", price: 120 },
            { label: "Mountain Dew Can", price: 120 },
            { label: "Coca Cola Can", price: 120 },
            { label: "Sprite Can", price: 120 },
            { label: "Fanta Can", price: 120 }
        ],
        img: "images/soft-drinks-can.jpg"
    },

    // Cold Drinks Bottles / Glass (NEW SEPARATE DROPDOWN)
    {
        id: "d14_bottles",
        type: "custom",
        name: "Cold Drinks",
        options: [
            { label: "Regular Bottle / Glass", price: 100 },
            { label: "500ml Bottle", price: 130 },
            { label: "1 Litre Bottle", price: 180 },
            { label: "1.5 Litre Bottle", price: 230 },
            { label: "2.25 Litre Bottle", price: 280 }
        ],
        img: "images/cold-drinks.jpg"
    },

    // Mineral Water (NEW SEPARATE DROPDOWN)
    {
        id: "d15_water",
        type: "custom",
        name: "Mineral Water Options",
        options: [
            { label: "Mineral Water (Small 500ml)", price: 80 },
            { label: "Mineral Water (Large 1.5L)", price: 140 }
        ],
        img: "images/mineral-water.jpg"
    },
    ...
    // Hot & Cold Desserts
    { id: "d21_gulab", type: "standard", name: "Gulab Jamun (2 Pcs)", price: 250, img: "images/gulab-jamun.jpg" },
    { id: "d21_kheer", type: "standard", name: "Special Shahi Kheer", price: 300, img: "images/kheer.jpg" },
    { id: "d21_brownie", type: "standard", name: "Sizzling Brownie with Ice Cream", price: 650, img: "images/brownie.jpg" },
...
function handleSendOrder() {
    ...
    let msg = "  NEW ORDER (Dream Cafe) FROM WEB APP \n\n";
